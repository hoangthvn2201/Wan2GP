...
class AssetBasedPipeline(LinearVideoPipeline):
    ...
    async def __call__(
        ...
        **kwargs
        ...
        """
        from Pixelle_video.pixelle_video.pipelines.linear import PipelineContext
    ...
    async def generate_content(self, context: PipelineContext) -> PipelineContext:
        ...
        """
        from Pixelle_video.pixelle_video.prompts.asset_script_generation import build_asset_script_prompt
