...
from Pixelle_video.pixelle_video.pipelines.base import BasePipeline
from Pixelle_video.pixelle_video.models.progress import ProgressEvent
...
class CustomPipeline(BasePipeline):
    ...
    async def __call__(
        ...
        from Pixelle_video.pixelle_video.utils.template_util import resolve_template_path, get_template_type
        ...
        from Pixelle_video.pixelle_video.utils.content_generators import generate_title
        ...
        if template_requires_image:
            ...
            from Pixelle_video.pixelle_video.utils.content_generators import generate_image_prompts
