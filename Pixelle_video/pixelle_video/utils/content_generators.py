...
async def generate_title(
    ...
    from Pixelle_video.pixelle_video.prompts import build_title_generation_prompt
...
async def generate_narrations_from_topic(
    ...
    """
    from Pixelle_video.pixelle_video.prompts import build_topic_narration_prompt
...
async def generate_narrations_from_content(
    ...
    Returns:
        List of narration texts
    """
    from Pixelle_video.pixelle_video.prompts import build_content_narration_prompt
...
async def generate_image_prompts(
    ...
    """
    from Pixelle_video.pixelle_video.prompts import build_image_prompt_prompt
...
async def generate_video_prompts(
    ...
    """
    from Pixelle_video.pixelle_video.prompts.video_generation import build_video_prompt_prompt
...
def _parse_json(text: str) -> dict:
    ...
    """
    # Strip any leaked reasoning/"thinking" block (Qwen3, DeepSeek-R1, etc.)
    # before attempting to parse, e.g. "<think>...</think>{json}".
