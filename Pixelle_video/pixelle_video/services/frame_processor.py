...
from Pixelle_video.pixelle_video.models.storyboard import Storyboard, StoryboardFrame, StoryboardConfig
...
class FrameProcessor:
    ...
    async def _compose_frame_html(
        ...
        from Pixelle_video.pixelle_video.utils.template_util import resolve_template_path
    ...
    async def _download_media(
        ...
        """Download media (image or video) from URL (or copy a local file) to the task dir"""
        from Pixelle_video.pixelle_video.utils.os_util import get_task_frame_path
