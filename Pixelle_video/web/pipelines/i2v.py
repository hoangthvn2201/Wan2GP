            ...
            if st.button(tr("btn.generate"), type="primary", use_container_width=True, key="i2v_generate"):
                ...
                try:
                    async def generate_audio_visual_video():
                        ...
                        # Wan2GP workflows run in-process (no ComfyUI server)
                        if workflow_config.get("source") == "wan2gp":
                            ...
                            shutil.copyfile(output_path, final_video_path)
