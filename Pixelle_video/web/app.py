...
# Add the Wan2GP repository root (parent of Pixelle_video) so that both the
# `Pixelle_video.*` package imports and the in-process WanGP API
# (`shared.api`) are importable.
_wan2gp_root = _project_root.parent
if str(_wan2gp_root) not in sys.path:
    sys.path.insert(0, str(_wan2gp_root))
